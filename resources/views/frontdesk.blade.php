...
<head>
  ...
  <link href="/tail/tailwind.css" rel="stylesheet"/>
    <link href="/css/guesttable.css" rel="stylesheet"/>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link nav-link-icon collapsed" href="manage_room">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            ...
            <a href="guestList">
              <i class="bi bi-circle" href="guestList"></i><span>Guest</span>
            </a>
        </ul>
      </li><!-- End Tables Nav -->
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      ...
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDialogScrollable">
                ...
                <div class="modal-dialog modal-dialog-scrollable">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Edit Frontdesk Data</h5>
          ...
          <div  class="gtable">
            <h2>Registered Frontdesk User</h2>
<table>
...
<header class="text-center font-bold text-lg">
    ...
    @foreach ($users as $user)
        <tr class="t_row">
            ...
            <td class="t_head">{{ $user->name }}</td>
            <td class="t_head">{{ $user->email }} </td>
            <td class="t_head">{{ $user->role }}</td>
           <td> </td>
                    </div>
                  </div>
                </div>
