      ...
      <div class="w-4/5 flex flex-col bg-gray-200 rounded-2xl p-5">
        <form method="POST" action="{{ route('store_date') }}">
          ...
          <div class="md:flex-row justify-center">
            ...
            <div class="w-full md:w-1/2 px-4 mb-4 md:mb-0 mx-auto">
          ...
          <div class="flex items-center justify-end">
            <div class="w-full md:w-1/2 px-4 ">
              <div class="flex flex-row-reverse mt-5 mb-10">
                <button  class="bg-yellow-500 text-white active:bg-yellow-800 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="submit"
